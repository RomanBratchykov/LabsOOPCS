...
{
    /// <inheritdoc />
    public partial class InitiateCreation : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HomeworkSubmissons", x => x.HomeworkId);
                    table.ForeignKey(
                        name: "FK_HomeworkSubmissons_Courses_CourseId",
                        column: x => x.CourseId,
                        principalTable: "Courses",
                        principalColumn: "CourseId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_HomeworkSubmissons_Students_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_HomeworkSubmissons_CourseId",
                table: "HomeworkSubmissons",
                column: "CourseId");

            migrationBuilder.CreateIndex(
                name: "IX_HomeworkSubmissons_StudentId",
                table: "HomeworkSubmissons",
                column: "StudentId");
